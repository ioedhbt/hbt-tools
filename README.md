...
| **EBL Calculator** | [`tools/ebeam/calculator.py`](tools/ebeam/calculator.py) | JEOL ELS-7000 chip-position & origin calculator; GDS mask viewer (streaming parser); dose-time test / first exposure / second alignment workflows with exposure-time estimates |
