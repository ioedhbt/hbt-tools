...
| **Gummel Plot Analyzer** | [`tools/IOED_Gummel_Analyzer.py`](tools/IOED_Gummel_Analyzer.py) | Overlay Gummel data vs a reference device; live ideality-factor extraction |
| **Measurement Data Multi-Process** | [`tools/csv_process.py`](tools/csv_process.py) | B1500A / CITI / HP4155A CSV batch converters with ZIP export |
