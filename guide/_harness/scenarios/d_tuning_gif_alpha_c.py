"""tuning.md — Visual Tuning GIF, part C: frames 06-09 (alpha0 -> 0.99).
Run with: bash guide/_harness/run.sh d_tuning_gif_alpha_c d_tuning_gif_alpha
Continues from parts A/B into the same output dir.
"""
...
def run(page, shot):
    ...
    # Fast-forward (uncaptured) to where part B left off (frames 03, 04).
    for _ in range(5):
