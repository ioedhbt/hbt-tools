...
# Raw (not de-embedded) file: the cached model carries the pad and lead
# parasitics, so it has to be fitted against the measurement that still
# has them. Run guide/_harness/seed_fit_cache.py first.
