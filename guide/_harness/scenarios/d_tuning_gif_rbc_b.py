"""tuning.md — Visual Tuning GIF, part B: frames 06-10 (Rbc ~280 -> 500 kOhm).
Run with: bash guide/_harness/run.sh d_tuning_gif_rbc_b d_tuning_gif_rbc
Continues from part A (d_tuning_gif_rbc_a.py) into the same output dir.
"""
