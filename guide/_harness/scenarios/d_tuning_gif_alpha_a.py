"""tuning.md — Visual Tuning GIF, part A: frames 00-05 (alpha0 0.95 -> ~0.97).
Run with: bash guide/_harness/run.sh d_tuning_gif_alpha_a d_tuning_gif_alpha
Part B (d_tuning_gif_alpha_b.py) continues 06-10 into the same output dir.
"""
...
def run(page, shot):
    ...
    # alpha0 is hard-limited to [0.95, 0.99] app-side (tune_hard_limits),
    # same range the brief asks for -- set Min/Max explicitly anyway so the
    # card's displayed range is unambiguous in the screenshot.
